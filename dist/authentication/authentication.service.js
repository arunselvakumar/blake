...
const httpclient_service_1 = require("../httpclient/httpclient.service");
let AuthenticationService = class AuthenticationService {
    ...
    getAccessToken(authCode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.httpService.get(graphQLUrlFormat, null, queryParam)
                .toPromise()
                .then((res) => {
                if (res.status === 200) {
                    return res.data;
    ...
    getAccountDetails(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.httpService.get(meEndPointUrl, null, queryParam)
                .toPromise()
                .then((res) => {
                if (res.status === 200) {
                    return res.data;
