...
const reviews_validation_provider_1 = require("../providers/reviews-validation.provider");
const reviews_service_1 = require("../services/reviews.service");
let ReviewsController = class ReviewsController {
    constructor(reviewsService, validationProvider) {
    ...
    addReviewForService(serviceId, request, addReviewRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = request;
            yield this.validationProvider.addValidator.validate(serviceId, user.id, addReviewRequest);
            const addReviewEntity = reviews_adapter_1.ReviewsAdapter.getReviewsEntityModel(user.id, serviceId, addReviewRequest);
    ...
    getReviewsForService(serviceId, page) {
        return __awaiter(this, void 0, void 0, function* () {
            const serviceResult = yield this.reviewsService.getReviewsForService(serviceId, page);
            return serviceResult.map(data => reviews_mapper_1.ReviewsMapper.mapFromReviewEntityToGetReviewResponseDto(data));
        });
    }
    deleteReview(reviewId, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = request;
            yield this.validationProvider.deleteValidator.validate(reviewId, user.id);
...
__decorate([
    ...
    common_1.UseGuards(passport_1.AuthGuard('bearer')),
    __param(0, common_1.Param('reviewId')), __param(1, common_1.Req()),
    __metadata("design:type", Function),
...
ReviewsController = __decorate([
    ...
    __metadata("design:paramtypes", [reviews_service_1.ReviewsService,
        reviews_validation_provider_1.ReviewsValidationProvider])
], ReviewsController);
