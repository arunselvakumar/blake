...
let DeleteReviewsValidator = class DeleteReviewsValidator {
    constructor(reviewsService) {
        this.reviewsService = reviewsService;
    }
    validate(reviewId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (validator.isEmpty(reviewId) || validator.isEmpty(userId)) {
                throw new common_1.BadRequestException();
            }
            const serviceResult = yield this.reviewsService.getReviewById(reviewId);
...
DeleteReviewsValidator = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [reviews_service_1.ReviewsService])
], DeleteReviewsValidator);
exports.DeleteReviewsValidator = DeleteReviewsValidator;
